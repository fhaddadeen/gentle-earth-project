...
<footer class="site-footer">
  <div class="footer-inner">
    ...
    <div class="footer-bottom">
      <span>&copy; ${new Date().getFullYear()} Gentle Earth Project. All rights reserved. &nbsp;<a href="privacy.html" style="color:rgba(255,255,255,0.45);text-decoration:underline;text-underline-offset:3px;">Privacy Policy</a></span>
...
/* ===================================
   ...
   =================================== */
(function() {
  if (localStorage.getItem('gep_cookie_consent')) return;
  ...
  banner.innerHTML = `
    <div style="
      ...
      background:#1E2912;color:rgba(255,255,255,0.85);
      padding:1.2rem 2rem;
      display:flex;align-items:center;justify-content:space-between;
      gap:1.5rem;flex-wrap:wrap;
      border-top:1px solid rgba(122,140,74,0.3);
      font-family:'Inter',system-ui,sans-serif;font-size:0.85rem;line-height:1.6;
    ...
    ">
      ...
      <div style="display:flex;gap:0.75rem;flex-shrink:0;">
        <button id="cookie-decline" style="
          padding:0.5rem 1.2rem;border-radius:4px;border:1.5px solid rgba(255,255,255,0.3);
          background:transparent;color:rgba(255,255,255,0.7);cursor:pointer;
          font-family:inherit;font-size:0.8rem;letter-spacing:0.04em;
        ">Decline</button>
        <button id="cookie-accept" style="
          padding:0.5rem 1.2rem;border-radius:4px;border:none;
          background:#7A8C4A;color:#fff;cursor:pointer;
          font-family:inherit;font-size:0.8rem;font-weight:500;letter-spacing:0.04em;
        ">Accept</button>
      </div>
    </div>
  `;
  ...
  document.getElementById('cookie-accept').addEventListener('click', function() {
    localStorage.setItem('gep_cookie_consent', 'accepted');
    banner.remove();
  });

  document.getElementById('cookie-decline').addEventListener('click', function() {
    localStorage.setItem('gep_cookie_consent', 'declined');
    banner.remove();
    // Disable GA if declined
    window['ga-disable-G-JCFDC5N212'] = true;
  });
})();
